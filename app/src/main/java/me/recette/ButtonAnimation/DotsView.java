...
public class DotsView extends View {
    ...
    private static final int COLOR_1 = 0xFF2ecc71;
    private static final int COLOR_2 = 0xFF2ecc71;
    private static final int COLOR_3 = 0xFFe74c3c;
    private static final int COLOR_4 = 0xFFe74c3c;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        centerY = h / 2;
        maxDotSize = 17;
        maxOuterDotsRadius = w / 5 - maxDotSize * 3;
        Log.d("max outer dot size", String.valueOf(maxOuterDotsRadius));
        maxInnerDotsRadius = 0.4f * maxOuterDotsRadius;
        Log.d("max inner dot size", String.valueOf(maxInnerDotsRadius));
    }
